...
const SignUpPage = () => {
  ...
  const onSubmit = (data) => {
    ...
    toast.success('Account Created!', {
      description: 'Welcome to CHROME·BLUSH. Please log in to continue.',
    });
  };

  return (
    <AuthLayout title="Create an Account" subtitle="Begin your transformation journey.">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Your Name" {...field} className="bg-zinc-800/50 border-zinc-700 focus:border-rose-400 focus:ring-rose-400" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          />
          <Button type="submit" className="w-full bg-rose-500 hover:bg-rose-600 text-white !mt-6" size="lg">
            Create Account
          </Button>
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-zinc-900/50 px-2 text-zinc-400">Or</span>
            </div>
          </div>
